...
import {Layout,Menu,Avatar,Icon,Modal,Dropdown,Row,Col,Tooltip} from 'antd' //Badge
...
class WimsHeader extends Component {
    ...
    toggle = () => {
        this.setState({
            ...
            this.props.handleToggleCollapse(this.state.collapsed);
        });
    }
                    ...
                    <Col xs={2} sm={4} lg={8}>
                        <h2 style={{overflow:'hidden',whiteSpace:'nowrap'}}>
                            <Icon
                                ...
                                onClick={this.toggle}
                            />
                            考务系统系统 {this.state.developVersionName && <span style={{color:'red',fontSize:'14px',paddingLeft:10}}>{this.state.developVersionName}</span>}
                        </h2>
                    </Col>
